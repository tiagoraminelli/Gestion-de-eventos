...
//$d = new Usuario();
$d = new UsuarioFilter();
$arregloUsuarios = $d->getUsuarioFilter();
...
<table class="hover:border-spacing-2 min-w-full divide-y divide-gray-200 mt-8" id="example">
    <tbody>
        ...
        <?php //abrimos llave 
        if(empty($arregloUsuarios)){ //en el caso que no existan elementos 
        ?> 
        <tr>
        ...
        <?php //abrimos llave 
        foreach ($arregloUsuarios as $subArreglo) { //el FOREACH del arreglo de disertantes y cada sub arreglo dentro
        //var_dump($subArreglo) ;
